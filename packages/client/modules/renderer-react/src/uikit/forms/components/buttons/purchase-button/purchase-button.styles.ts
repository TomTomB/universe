import beIcon from './assets/images/be-icon.png';
import rpIcon from './assets/images/icon-rp-gradient-32.png';
...
export const ContentIconRp = styled(ContentIcon)`
  background: url(${rpIcon}) center center no-repeat;
  background-size: contain;
`;

export const ContentIconBe = styled(ContentIcon)`

...
export const FrameDefault = styled(Frame)`
  opacity: 1;
...
export const FrameHover = styled(Frame)`
...
export const FrameActive = styled(Frame)`
  transition-duration: 100ms;
  border-image-source: linear-gradient(to top, #6b5024, #463714);
`;

export const FrameDisabled = styled(Frame)`
  border-color: #5c5b57;
`;
